<template>
    <div id="wrapperAdmin">
        ...
        <div class="mb-2">
            ...
            <div v-if="allSelected && requiresClient">
                <InputEmailSelector v-model="bookingForm.email" @selectedClient="selectedClient"/>
                <div v-if="!clientIsSelected" :class="[hasErrorEmail?'hide-cf':'']">

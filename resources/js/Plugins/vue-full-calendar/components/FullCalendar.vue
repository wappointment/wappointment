...
<script>
    ...
    var overridenCss = $.fn.css;
    $.fn.css = function (name,value){
        let result =  overridenCss.apply(this, arguments); 
        if($(this).hasClass('fc-now-indicator-line') && name == 'top' && value !== '' && value!==undefined && value > 0){
    ...
    export default {
        ...
        methods: {
            ...
            unselect() {
                return $(this.$el).fullCalendar('unselect')
            },
            fireMethod(...options) {
                return $(this.$el).fullCalendar(...options)
            },
            option(optioname, optionvalue) {
                return $(this.$el).fullCalendar('option', optioname, optionvalue)
            },
        },

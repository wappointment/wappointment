 ...
 * @author Chris Corbyn
 */
class WappoSwift_CharacterStream_ArrayCharacterStream implements WappoSwift_CharacterStream
{
     ...
     *
     * @param WappoSwift_CharacterReaderFactory $factory for loading validators
     ...
     *
     * @param WappoSwift_OutputByteStream $os output stream to read from
     */

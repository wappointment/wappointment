 ...
 * @author     Chris Corbyn
 */
class WappoSwift_Plugins_PopBeforeSmtpPlugin implements WappoSwift_Events_TransportChangeListener, WappoSwift_Plugins_Pop_Pop3Connection
{
     ...
     * @return $this
     */
    public function setConnection(WappoSwift_Plugins_Pop_Pop3Connection $connection)
    {
     ...
     */
    public function bindSmtp(WappoSwift_Transport $smtp)
    {
        $this->transport = $smtp;
    }
     ...
     *
     * @throws WappoSwift_Plugins_Pop_Pop3Exception if connection fails
     */
        ...
        if (isset($this->connection)) {
            ...
            if (!isset($this->socket)) {
                if (!$socket = fsockopen(
                    ...
                    throw new WappoSwift_Plugins_Pop_Pop3Exception(

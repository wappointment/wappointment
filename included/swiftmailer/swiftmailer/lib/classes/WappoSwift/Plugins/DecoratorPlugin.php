 ...
 */
class WappoSwift_Plugins_DecoratorPlugin implements WappoSwift_Events_SendListener, WappoSwift_Plugins_Decorator_Replacements
{
    /** The replacement map */
     ...
     * of {@link WappoSwift_Plugins_Decorator_Replacements}.
     *
     ...
     * </code>
     *
     * When using an instance of {@link WappoSwift_Plugins_Decorator_Replacements},
     * the object should return just the array of replacements for the address
     * given to {@link WappoSwift_Plugins_Decorator_Replacements::getReplacementsFor()}.
     *
     * @param mixed $replacements Array or WappoSwift_Plugins_Decorator_Replacements
     */
    ...
    {
        if (!($replacements instanceof WappoSwift_Plugins_Decorator_Replacements)) {
     ...
     * {@link WappoSwift_Plugins_Decorator_Replacements} then the call will be
    ...
    {
        if ($this->replacements instanceof WappoSwift_Plugins_Decorator_Replacements) {
    ...
    private function restoreMessage(WappoSwift_Mime_SimpleMessage $message)
    {

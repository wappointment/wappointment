 ...
 * @author     Chris Corbyn
 */
class WappoSwift_Plugins_LoggerPlugin implements WappoSwift_Events_CommandListener, WappoSwift_Events_ResponseListener, WappoSwift_Events_TransportChangeListener, WappoSwift_Events_TransportExceptionListener, WappoSwift_Plugins_Logger
{
     ...
     */
    public function __construct(WappoSwift_Plugins_Logger $logger)
    {
        $this->logger = $logger;
    }
     ...
     */
    public function commandSent(WappoSwift_Events_CommandEvent $evt)
    {
    ...
    public function exceptionThrown(WappoSwift_Events_TransportExceptionEvent $evt)
    {
        ...
        $evt->cancelBubble();
        throw new WappoSwift_TransportException($message, $code, $e->getPrevious());
    }
}

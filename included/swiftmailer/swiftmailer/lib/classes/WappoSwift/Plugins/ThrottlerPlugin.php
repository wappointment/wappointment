 ...
 * @author Chris Corbyn
 */
class WappoSwift_Plugins_ThrottlerPlugin extends WappoSwift_Plugins_BandwidthMonitorPlugin implements WappoSwift_Plugins_Sleeper, WappoSwift_Plugins_Timer
{
     ...
     *
     * @var WappoSwift_Plugins_Sleeper
     */
    private $sleeper;
     ...
     * @param WappoSwift_Plugins_Sleeper $sleeper (only needed in testing)
     * @param WappoSwift_Plugins_Timer   $timer   (only needed in testing)
     */
    public function __construct($rate, $mode = self::BYTES_PER_MINUTE, WappoSwift_Plugins_Sleeper $sleeper = null, WappoSwift_Plugins_Timer $timer = null)
    {
        $this->rate = $rate;
        $this->mode = $mode;

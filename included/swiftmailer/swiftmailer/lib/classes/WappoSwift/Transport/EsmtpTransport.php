 ...
 * @author Chris Corbyn
 */
class WappoSwift_Transport_EsmtpTransport extends WappoSwift_Transport_AbstractSmtpTransport implements WappoSwift_Transport_SmtpAgent
{
    /**
     * ESMTP extension handlers.
     *
     * @var WappoSwift_Transport_EsmtpHandler[]
     */
    private $handlers = [];
    ...
    private $params = [
        ...
        'blocking' => 1,
        'tls' => false,
        'type' => WappoSwift_Transport_IoBuffer::TYPE_SOCKET,
     ...
     *
     * @param WappoSwift_Transport_EsmtpHandler[] $extensionHandlers
     * @param string                         $localDomain
     */
    public function __construct(WappoSwift_Transport_IoBuffer $buf, array $extensionHandlers, WappoSwift_Events_EventDispatcher $dispatcher, $localDomain = '127.0.0.1', WappoSwift_AddressEncoder $addressEncoder = null)
    {
     ...
     *
     * @param WappoSwift_Transport_EsmtpHandler[] $handlers
     *
     * @return $this
     */
     ...
     *
     * @return WappoSwift_Transport_EsmtpHandler[]
     */
        ...
        if ($this->params['tls']) {
            try {
                ...
                if (!$this->buffer->startTLS()) {
                    throw new WappoSwift_TransportException('Unable to connect with TLS encryption');
                }

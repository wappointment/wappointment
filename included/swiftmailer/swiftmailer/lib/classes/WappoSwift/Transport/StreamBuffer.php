 ...
 * @author     Chris Corbyn
 */
class WappoSwift_Transport_StreamBuffer extends WappoSwift_ByteStream_AbstractFilterableInputStream implements WappoSwift_Transport_IoBuffer
{
    /** A primary socket */
    private $stream;
     ...
     */
    public function __construct(WappoSwift_ReplacementFilterFactory $replacementFactory)
    {
    ...
    private function establishSocketConnection()
    {
        ...
        if (false === $this->stream) {
            throw new WappoSwift_TransportException(

 ...
 * WappoSwift_Mime_ContentEncoder_PlainContentEncoder in "8bit" mode.
 *
 ...
 */
class WappoSwift_Transport_Esmtp_EightBitMimeHandler implements WappoSwift_Transport_EsmtpHandler
{
    protected $encoding;

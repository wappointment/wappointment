 ...
 * @author Chris Corbyn
 */
class WappoSwift_Transport_Esmtp_AuthHandler implements WappoSwift_Transport_EsmtpHandler
{
    /**
     * Authenticators available to process the request.
     *
     * @var WappoSwift_Transport_Esmtp_Authenticator[]
     */
     ...
     *
     * @param WappoSwift_Transport_Esmtp_Authenticator[] $authenticators
     */
     ...
     *
     * @return WappoSwift_Transport_Esmtp_Authenticator[]
     */
     ...
     *
     * @param WappoSwift_Transport_SmtpAgent $agent to read/write
     */
    public function afterEhlo(WappoSwift_Transport_SmtpAgent $agent)
    {
        if ($this->username) {
            $count = 0;
            $errors = [];
            ...
            throw new WappoSwift_TransportException($message);
        }
    }
     ...
     * Not used.
     */
    public function onCommand(WappoSwift_Transport_SmtpAgent $agent, $command, $codes = [], &$failedRecipients = null, &$stop = false)
    {
    }
    ...
    protected function getAuthenticatorsForAgent()
    {
        ...
        throw new WappoSwift_TransportException('Auth mode '.$mode.' is invalid');
    }
}

 ...
 */
class WappoSwift_Transport_Esmtp_Auth_NTLMAuthenticator implements WappoSwift_Transport_Esmtp_Authenticator
{
     ...
     */
    protected function sendMessage1(WappoSwift_Transport_SmtpAgent $agent)
    {
     ...
     * @return string
     */
    protected function sendMessage3($response, $username, $password, $timestamp, $client, WappoSwift_Transport_SmtpAgent $agent, $v2 = true)
    {

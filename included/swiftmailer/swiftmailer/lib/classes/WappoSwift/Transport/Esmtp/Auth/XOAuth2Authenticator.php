 ...
 * Example:
 * <code>
 * $transport = (new WappoSwift_SmtpTransport('smtp.gmail.com', 587, 'tls'))
 *   ->setAuthMode('XOAUTH2')
 ...
 */
class WappoSwift_Transport_Esmtp_Auth_XOAuth2Authenticator implements WappoSwift_Transport_Esmtp_Authenticator
{
    /**
     ...
     * {@inheritdoc}
     */
    public function authenticate(WappoSwift_Transport_SmtpAgent $agent, $email, $token)
    {
        try {

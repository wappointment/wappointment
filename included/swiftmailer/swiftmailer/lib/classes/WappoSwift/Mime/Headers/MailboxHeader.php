 ...
 * @author Chris Corbyn
 */
class WappoSwift_Mime_Headers_MailboxHeader extends WappoSwift_Mime_Headers_AbstractHeader
{
    /**
     ...
     */
    public function __construct($name, WappoSwift_Mime_HeaderEncoder $encoder, EmailValidator $emailValidator, WappoSwift_AddressEncoder $addressEncoder = null)
    {
     ...
     * <code>
     * <?php
     * $header = new WappoSwift_Mime_Headers_MailboxHeader('From',
     ...
     *
     * @throws WappoSwift_RfcComplianceException If invalid.
     */
    private function assertValidAddress($address)
    {
        if (!$this->emailValidator->isValid($address, new RFCValidation())) {
            throw new WappoSwift_RfcComplianceException(

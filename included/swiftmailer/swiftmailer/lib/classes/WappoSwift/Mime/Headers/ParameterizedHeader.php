 ...
 * @author Chris Corbyn
 */
class WappoSwift_Mime_Headers_ParameterizedHeader extends WappoSwift_Mime_Headers_UnstructuredHeader
{
    /**
     ...
     * @param string $name
     */
    public function __construct($name, WappoSwift_Mime_HeaderEncoder $encoder, WappoSwift_Encoder $paramEncoder = null)
    {

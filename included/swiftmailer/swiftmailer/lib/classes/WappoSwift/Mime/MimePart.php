 ...
 * @author Chris Corbyn
 */
class WappoSwift_Mime_MimePart extends WappoSwift_Mime_SimpleMimeEntity
{
    ...
    protected function convertString($string)
    {
        ...
        if (!in_array($charset, ['utf-8', 'iso-8859-1', 'iso-8859-15', ''])) {
            ...
            if (function_exists('mb_convert_encoding')) {
                ...
                throw new WappoSwift_SwiftException('No suitable convert encoding function (use UTF-8 as your charset or install the mbstring or iconv extension).');
            }

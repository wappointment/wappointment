...
class Settings
{
    ...
    public static function allDefaults()
    {
        return [
            ...
            'reschedule_link' => 'Reschedule',//__('Reschedule', 'wappointment'),
            'cancellation_link' => 'Cancel',//__('Cancel', 'wappointment'),
            'save_appointment_text_link' => 'Save to calendar',//__('Save to calendar', 'wappointment'),
            'new_booking_link' => 'Book a new appointment',//__('Book a new appointment', 'wappointment'),
            'booking_page' => 0,
            'show_welcome' => false,
            ...
            'invoice' => false,
            'invoice_seller' => '',
            'invoice_num' => 'Order nº',//__('Order nº', 'wappointment'),
            'invoice_client' => ['name'],
            'wp_remote' => false,
            'jitsi_url' => '',

...
class FoundationEmail
{
  ...
  {
    return $this->wrapRow('<center><a class="text-center" href="' . Helpers::wappointment_link('email', 'daily_email') . '"><img class="float-center" src="' .
  ...
  public function wrapRow($content_lines, $classRow = 'row', $tableClass = '', $columnClass = 'columns', $spacer = true)
  {
    ...
    return
      '<table align="center" class="container float-center ' . $tableClass . '">
        <tbody>
          <tr>
            <td>
              ' . ($spacer ? $this->spacer() : '') . '
    ...
    return [
      'button.primary' => 'table.button {
                            ...
                            table.button:active table a {
                              border: 0 solid ' . $this->getColor('primaryLight') . '; }',

      'button.secondary' => 'table.button.secondary table td {
                                background: #777777;
                                color: #fefefe;
      ...
      'button.success' => 'table.button.success table td {
                                background: #3adb76;
      ...
      'button.alert' => 'table.button.alert table td {
                              background: #ec5840;
      ...
      'button.warning' => 'table.button.warning table td {
                              background: #ffae00;

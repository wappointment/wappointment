 ...
 * @author Chris Corbyn
 */
class WappoSwift_Events_SimpleEventDispatcher implements WappoSwift_Events_EventDispatcher
{
    ...
    {
        $this->eventMap = [
            'WappoSwift_Events_CommandEvent' => 'WappoSwift_Events_CommandListener',
            'WappoSwift_Events_ResponseEvent' => 'WappoSwift_Events_ResponseListener',
            'WappoSwift_Events_SendEvent' => 'WappoSwift_Events_SendListener',
            'WappoSwift_Events_TransportChangeEvent' => 'WappoSwift_Events_TransportChangeListener',
            'WappoSwift_Events_TransportExceptionEvent' => 'WappoSwift_Events_TransportExceptionListener',
            ];
    }
    ...
    {
        return new WappoSwift_Events_SendEvent($source, $message);
    }
    ...
    {
        return new WappoSwift_Events_CommandEvent($source, $command, $successCodes);
    }
    ...
    {
        return new WappoSwift_Events_ResponseEvent($source, $response, $valid);
    }
    ...
    {
        return new WappoSwift_Events_TransportChangeEvent($source);
    }
    ...
    {
        return new WappoSwift_Events_TransportExceptionEvent($source, $ex);
    }
    ...
    private function prepareBubbleQueue(WappoSwift_Events_EventObject $evt)
    {
        $this->bubbleQueue = [];
    ...
    private function bubble(WappoSwift_Events_EventObject $evt, $target)
    {

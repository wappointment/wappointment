 ...
 * @author Chris Corbyn
 */
class WappoSwift_Events_SendEvent extends WappoSwift_Events_EventObject
{
     ...
     *
     * @var WappoSwift_Mime_SimpleMessage
     */
    private $message;
     ...
     */
    public function __construct(WappoSwift_Transport $source, WappoSwift_Mime_SimpleMessage $message)
    {
     ...
     *
     * @return WappoSwift_Mime_SimpleMessage
     */

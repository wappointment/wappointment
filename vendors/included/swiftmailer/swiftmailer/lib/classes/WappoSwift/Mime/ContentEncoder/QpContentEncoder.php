 ...
 * @author     Chris Corbyn
 */
class WappoSwift_Mime_ContentEncoder_QpContentEncoder extends WappoSwift_Encoder_QpEncoder implements WappoSwift_Mime_ContentEncoder
{
    protected $dotEscape;
     ...
     *
     * @param WappoSwift_CharacterStream $charStream to use for reading characters
     * @param WappoSwift_StreamFilter    $filter     if canonicalization should occur
     * @param bool                  $dotEscape  if dot stuffing workaround must be enabled
     */
    public function __construct(WappoSwift_CharacterStream $charStream, WappoSwift_StreamFilter $filter = null, $dotEscape = false)
    {
     ...
     * $firstLineOffset.
     *
     * @param WappoSwift_OutputByteStream $os              output stream
     * @param WappoSwift_InputByteStream  $is              input stream

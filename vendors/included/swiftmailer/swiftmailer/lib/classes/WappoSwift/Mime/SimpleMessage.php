 ...
 * @author Chris Corbyn
 */
class WappoSwift_Mime_SimpleMessage extends WappoSwift_Mime_MimePart
{
     ...
     */
    public function __construct(WappoSwift_Mime_SimpleHeaderSet $headers, WappoSwift_Mime_ContentEncoder $encoder, WappoSwift_KeyCache $cache, WappoSwift_IdGenerator $idGenerator, $charset = null)
    {
    ...
    /**
     * Attach a {@link WappoSwift_Mime_SimpleMimeEntity} such as an Attachment or MimePart.
     *
     * @return $this
     */
    public function attach(WappoSwift_Mime_SimpleMimeEntity $entity)
    {
     ...
     * @return $this
     */
    public function detach(WappoSwift_Mime_SimpleMimeEntity $entity)
    {
        $newChildren = [];
    ...
    /**
     * Attach a {@link WappoSwift_Mime_SimpleMimeEntity} and return it's CID source.
     *
     * This method should be used when embedding images or other data in a message.
     *
     * @return string
     */
    public function embed(WappoSwift_Mime_SimpleMimeEntity $entity)
    {
        $this->attach($entity);
    ...
    /** @see WappoSwift_Mime_SimpleMimeEntity::getIdField() */

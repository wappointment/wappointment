 ...
 * @author     Chris Corbyn
 */
abstract class WappoSwift_Mime_Headers_AbstractHeader implements WappoSwift_Mime_Header
{
     ...
     */
    public function setEncoder(WappoSwift_Mime_HeaderEncoder $encoder)
    {
     ...
     *
     * @return WappoSwift_Mime_HeaderEncoder
     */
     ...
     * @return string
     */
    protected function createPhrase(WappoSwift_Mime_Header $header, $string, $charset, WappoSwift_Mime_HeaderEncoder $encoder = null, $shorten = false)
    {
     ...
     * @return string
     */
    protected function encodeWords(WappoSwift_Mime_Header $header, $input, $usedLength = -1)
    {
        $value = '';

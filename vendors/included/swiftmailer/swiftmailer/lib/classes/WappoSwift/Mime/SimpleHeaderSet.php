 ...
 * @author Chris Corbyn
 */
class WappoSwift_Mime_SimpleHeaderSet implements WappoSwift_Mime_CharsetObserver
{
    /** HeaderFactory */
    private $factory;
     ...
     */
    public function __construct(WappoSwift_Mime_SimpleHeaderFactory $factory, $charset = null)
    {
     ...
     * @param int $index
     */
    public function set(WappoSwift_Mime_Header $header, $index = 0)
    {
    ...
    private function storeHeader($name, WappoSwift_Mime_Header $header, $offset = null)
    {
    ...
    private function isDisplayed(WappoSwift_Mime_Header $header)
    {

 ...
 * @author Chris Corbyn
 */
class WappoSwift_Plugins_BandwidthMonitorPlugin implements WappoSwift_Events_SendListener, WappoSwift_Events_CommandListener, WappoSwift_Events_ResponseListener, WappoSwift_InputByteStream
{
    /**

 ...
 */
class WappoSwift_Plugins_RedirectingPlugin implements WappoSwift_Events_SendListener
{
    /**
     ...
     * @param string $type
     */
    private function filterHeaderSet(WappoSwift_Mime_SimpleHeaderSet $headerSet, $type)
    {

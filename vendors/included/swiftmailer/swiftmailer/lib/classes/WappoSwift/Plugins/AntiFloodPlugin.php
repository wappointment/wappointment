 ...
 * @author Chris Corbyn
 */
class WappoSwift_Plugins_AntiFloodPlugin implements WappoSwift_Events_SendListener, WappoSwift_Plugins_Sleeper
{
    /**
     ...
     * @param WappoSwift_Plugins_Sleeper $sleeper   (not needed really)
     */
    public function __construct($threshold = 99, $sleep = 0, WappoSwift_Plugins_Sleeper $sleeper = null)
    {

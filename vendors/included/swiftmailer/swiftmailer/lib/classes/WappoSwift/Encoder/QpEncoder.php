 ...
 * @author     Chris Corbyn
 */
class WappoSwift_Encoder_QpEncoder implements WappoSwift_Encoder
{
    /**
     * The CharacterStream used for reading characters (as opposed to bytes).
     *
     * @var WappoSwift_CharacterStream
     */
     ...
     * @param WappoSwift_StreamFilter    $filter     if input should be canonicalized
     */
    public function __construct(WappoSwift_CharacterStream $charStream, WappoSwift_StreamFilter $filter = null)
    {

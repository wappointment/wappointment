...
class WappoSwift_Mailer
{
     ...
     */
    public function __construct(WappoSwift_Transport $transport)
    {
    ...
    {
        return WappoSwift_DependencyContainer::getInstance()
    ...
    public function send(WappoSwift_Mime_SimpleMessage $message, &$failedRecipients = null)
    {
        ...
        } catch (WappoSwift_RfcComplianceException $e) {

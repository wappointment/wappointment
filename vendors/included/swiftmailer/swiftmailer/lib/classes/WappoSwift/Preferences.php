...
class WappoSwift_Preferences
{
    ...
    {
        WappoSwift_DependencyContainer::getInstance()->register('properties.charset')->asValue($charset);
    ...
    {
        WappoSwift_DependencyContainer::getInstance()->register('tempdir')->asValue($dir);
    ...
    {
        WappoSwift_DependencyContainer::getInstance()->register('cache')->asAliasOf(sprintf('cache.%s', $type));

 ...
 *
 * This encoder must be used together with WappoSwift_Transport_Esmtp_SmtpUtf8Handler
 ...
 * WappoSwift_AddressEncoder_IdnAddressEncoder instead. This allows sending to email
 * addresses with non-ASCII characters in the domain, but not in local-part.
 *
 * @author Christian Schmidt
 */
class WappoSwift_AddressEncoder_Utf8AddressEncoder implements WappoSwift_AddressEncoder
{
    /**

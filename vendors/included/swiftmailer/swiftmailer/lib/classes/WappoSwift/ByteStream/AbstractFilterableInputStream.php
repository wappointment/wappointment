 ...
 * @author Chris Corbyn
 */
abstract class WappoSwift_ByteStream_AbstractFilterableInputStream implements WappoSwift_InputByteStream, WappoSwift_Filterable
{
    /**
     * Write sequence.
     */
     ...
     * Bound streams.
     *
     * @var WappoSwift_InputByteStream[]
     */
    private $mirrors = [];
     ...
     * @param string $key
     */
    public function addFilter(WappoSwift_StreamFilter $filter, $key)
    {
